...
model = dict(
    type='SipMask',
    backbone=dict(
        type='ResNet_depth',  # ResNet 백본을 사용
        depth=50,  # ResNet의 깊이 설정 (50, 101 등)
        num_stages=4,
        out_indices=(0, 1, 2, 3),
        frozen_stages=1,
        in_channels=4,  # 4채널 입력으로 변경
...
log_level = 'INFO'
work_dir = './work_dirs/sipmask_rgbd50_input_fusion_ensesnso'
load_from = "/home/rise/Documents/pkb/sipmask/tools/work_dirs/sipmask_rgbd50_input_fusion_ensesnso/epoch_80.pth"
resume_from = "/home/rise/Documents/pkb/sipmask/tools/work_dirs/sipmask_rgbd50_input_fusion_ensesnso/epoch_80.pth"
workflow = [('train', 1)]
