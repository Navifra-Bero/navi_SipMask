...
def build_dataset(cfg, default_args=None):
    ...
    if isinstance(cfg, (list, tuple)):
        ...
        # img_prefix_rgb와 img_prefix_depth를 CocoDataset에 전달
        if 'img_prefix_rgb' in cfg:
            print("Img prefix")
            print(cfg['img_prefix_rgb'])
            cfg['img_prefix'] = [cfg['img_prefix_rgb'], cfg['img_prefix_depth']]
